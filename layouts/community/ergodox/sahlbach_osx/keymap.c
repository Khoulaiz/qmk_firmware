 ...
 * |--------+------+------+------+------+--------------|           |------+------+------+------+------+------+--------|
 * | DEL    |   Q  |  W   |  E   |   R  |   T  |   ü   |           |  ß   |   Y  |   U  |   I  |   O  |   P  |  \  |  |
 * |--------+------+------+------+------+------|       |           |      |------+------+------+------+------+--------|
 * | TAB    | A/LT1| S/ALT| D/CTL| F/CMD| G/SFT|-------|           |------| H/SFT| J/CMD| K/CTL| L/ALT| S/; :|  ' "   |
 * |--------+------+------+------+------+------|   ä   |           |  ö   |------+------+------+------+------+--------|
...
[BASE]=LAYOUT_ergodox(
        // left hand
                ...
                KC_DELETE,       KC_Q,          KC_W,        KC_E,         KC_R,        KC_T,        M(UMLAUT_UE),
                                 ALL_T(KC_TAB), LT(1,KC_A),  ALT_T(KC_S),  CTL_T(KC_D), GUI_T(KC_F), SFT_T(KC_G),
                KC_LSHIFT,       KC_Z,          KC_X,        KC_C,         KC_V,        KC_B,        M(UMLAUT_AE),
                TG(2),           KC_GRAVE,      KC_QUOTE,    MEH_T(KC_NO), MO(2),
                                                                                   LT(4,KC_APPLICATION), KC_LGUI,
                                                                                                         KC_HOME,
                                                                        KC_BSPACE, LT(3,KC_TAB),         KC_END,
        // right hand
                KC_ESCAPE,    KC_6,        KC_7,         KC_8,         KC_9,         KC_0,               KC_MINUS,
                M(UMLAUT_SZ), KC_Y,        KC_U,         KC_I,         KC_O,         KC_P,               KC_BSLASH,
                              SFT_T(KC_H), RGUI_T(KC_J), RCTL_T(KC_K), ALGR_T(KC_L), LT(1,KC_SCOLON),    KC_QUOTE,
                M(UMLAUT_OE), KC_N,        KC_M,         KC_COMMA,     KC_DOT,       KC_SLASH,           KC_RSHIFT,
...
// If it accepts an argument (i.e, is a function), it doesn't need KC_.
// Otherwise, it needs KC_*
[SYMB] = LAYOUT_ergodox(  // layer 1 : Symbol Layer
        // left hand
